...
public class RecyclerViewItemDecoration extends RecyclerView.ItemDecoration {
    ...
    private RecyclerViewItemDecoration(int height, int lPadding, int rPadding, int colour) {
        mHeight = height;
        mLPadding = lPadding;
        mRPadding = rPadding;
        mPaint = new Paint();
    ...
    public static class Builder {
         ...
         */
        public RecyclerViewItemDecoration.Builder setHeight(float pixels) {
         ...
         * @return the current instance of the Builder
         */
        public RecyclerViewItemDecoration.Builder setHeight(@DimenRes int resource) {
         ...
         * @return the current instance of the Builder
         */
        public RecyclerViewItemDecoration.Builder setPadding(float pixels) {
         ...
         * @return the current instance of the Builder
         */
        public RecyclerViewItemDecoration.Builder setPadding(@DimenRes int resource) {
         ...
         * @return the current instance of the Builder
         */
        public RecyclerViewItemDecoration.Builder setLeftPadding(float pixelPadding) {
         ...
         * @return the current instance of the Builder
         */
        public RecyclerViewItemDecoration.Builder setRightPadding(float pixelPadding) {
         ...
         * @return the current instance of the Builder
         */
        public RecyclerViewItemDecoration.Builder setLeftPadding(@DimenRes int resource) {
         ...
         * @return the current instance of the Builder
         */
        public RecyclerViewItemDecoration.Builder setRightPadding(@DimenRes int resource) {
         ...
         * @return the current instance of the Builder
         */
        public RecyclerViewItemDecoration.Builder setColorResource(@ColorRes int resource) {
         ...
         * @return the current instance of the Builder
         */
        public RecyclerViewItemDecoration.Builder setColor(@ColorInt int color) {
            mColour = color;
        ...
        public RecyclerViewItemDecoration build() {
            return new RecyclerViewItemDecoration(mHeight, mLPadding, mRPadding, mColour);
        }
    }
}
